...
#function to build the rectangular shape
...
while True:
    ...
    for bb in bbox:
        ...
        cv2.rectangle(frame,(bb[0],bb[1]-30), (bb[2],bb[1]), (0,255,0),-1)
        cv2.putText(frame,label, (bb[0],bb[1]-10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,255,255), 2)
